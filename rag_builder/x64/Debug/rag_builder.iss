...
DefaultDirName={autopf}\STN-LABZ\{#MyAppName}
...
Source: "rag_builder.exe"; \
    DestDir: "{app}"; \
    Flags: ignoreversion
Source: "C:\Users\Poe\Documents\GitHub\rag_builder\rag_builder\x64\Debug\config\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\Poe\Documents\GitHub\rag_builder\modules\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
